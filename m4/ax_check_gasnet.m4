...
AS_IF([test "x$gasnet" = xyes],[
  ...
  _AX_CHECK_GASNET_CONDUIT(axiom,$CXX,-L$ROOTFS/usr/lib -laxiom_allocator -levi_lmm -laxiom_user_api -laxiom_run_api -laxiom_init_api,[-I$ROOTFS/usr/include/axiom],[-Wl,-T$ROOTFS/usr/axiom-evi-allocator-lib/xs_map64.lds])
